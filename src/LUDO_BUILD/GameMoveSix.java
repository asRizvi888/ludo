...
public class GameMoveSix extends JPanel implements KeyListener, ActionListener,MouseListener{
    ...
    public void paint(Graphics g) {
    	...
    	p.draw((Graphics2D)g);
		g.drawString("6 coins mode", 600, 50);
    	...
    	if(p.pl[current_player].coin==4) {
			...
			String imgPath = "dice"+dice+".png";
			
			ImageIcon img = new ImageIcon(getClass().getResource(imgPath));
			img.paintIcon(this, g, 700, 250);
